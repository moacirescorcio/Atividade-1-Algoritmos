...
//entrada
const quantia = Number(question('Valor a sacar: '))
...
//saída
console.log('Serão', cem,'de R$100', ciquenta,'de R$50', vinte,'de R$20', dez,'de R$10', cinco,'de R$5', dois,'de R$2 e',um, 'de R$1.')
